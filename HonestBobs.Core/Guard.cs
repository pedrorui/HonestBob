...
namespace HonestBobs.Core
{
    ...
    public static class Guard
    {
        ...
        public static void Against<TException>(bool assertion, string message) where TException : Exception, new()
        {
            if (assertion)
            {
        ...
        public static void Against<TException>(Func<bool> assertion, string message) where TException : Exception, new()
        {
        ...
        /// <summary>
        /// Throw an exception of type <see cref="ArgumentNullException"/> when the specified object
        /// instance is null.
        /// </summary>
